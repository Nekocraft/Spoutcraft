...
public class TextureStitched implements Icon {
	...
	public static TextureStitched makeTextureStitched(String par0Str) {
		TextureStitched var1 = ModLoader.getCustomAnimationLogic(par0Str);
		return (TextureStitched)(var1 != null ? var1 : ("clock".equals(par0Str) ? new TextureClock() : ("compass".equals(par0Str) ? new TextureCompass() : new TextureStitched(par0Str))));
	}
