			...
			for (var8 = 0; var8 < 4; ++var8) {
				...
				if (par1Packet130UpdateSign.signLines[var8].length() > 15) {
					...
					for (var6 = 0; var6 < par1Packet130UpdateSign.signLines[var8].length(); ++var6) {
                        ...
                        // Chinese Input (Thanks to sunny00123!)
						if (ChatAllowedCharacters.allowedCharacters.indexOf(par1Packet130UpdateSign.signLines[var8].charAt(var6)) < 0 && par1Packet130UpdateSign.signLines[var8].charAt(var6) < 32){	
						var5 = false;
						}
					}
				}
